 ...
 */
/* ----------------------------------------------------------------------------*/
typedef void (*LSODA_ODE_SYSTEM_TYPE)(double t, double *y, double *dydt, double data);
...
public:
    ...
    void prja(const size_t neq, vector<double> &y, LSODA_ODE_SYSTEM_TYPE f, double data);
    ...
    void stoda(const size_t neq, vector<double> &y, LSODA_ODE_SYSTEM_TYPE f, double data);
    ...
    void lsoda_update(LSODA_ODE_SYSTEM_TYPE f, const size_t neq, vector<double> &y,
        ...
        double data, double rtol = 1e-6, double atol = 1e-6  // Tolerance
    );
